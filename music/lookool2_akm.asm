...
Lookool_Instrument5Loop	db 45	; Volume: 11.
...
Lookool_Instrument6Loop	db 173	; Volume: 11.
	db 24	; Arpeggio: 12.
...
Lookool_DisarkByteRegionStart11
Lookool_Arpeggio1
	db 1	; Speed
...
Lookool_DisarkByteRegionEnd11

Lookool_PitchIndexes
Lookool_DisarkPointerRegionStart12
	dw Lookool_Pitch1
Lookool_DisarkPointerRegionEnd12

Lookool_DisarkByteRegionStart13
Lookool_Pitch1
	db 0	; Speed

	db -18	; Value: -9
	db 0 * 2 + 1	; Loops to index 0.
Lookool_DisarkByteRegionEnd13
...
Lookool_Subsong0DisarkByteRegionStart1
	...
	db 6	; Second most used instrument.
...
Lookool_Subsong0_Track3
	...
	db 150	; Primary instrument (5). Note reference (6). Secondary wait (1).
	db 217	; Primary instrument (5). Note reference (9). New wait (3).
	db 3	;   Escape wait value.
	db 89	; Primary instrument (5). Note reference (9). Primary wait (0).
	db 89	; Primary instrument (5). Note reference (9). Primary wait (0).
	db 81	; Primary instrument (5). Note reference (1). Primary wait (0).
...
Lookool_Subsong0_Track6
	db 12	; Note with effects flag.
	db 171	; Secondary instrument (6). Note reference (11). Secondary wait (1).
	db 0	;    Reset effect, with inverted volume: 0.
	db 168	; Secondary instrument (6). Note reference (8). Secondary wait (1).
	db 104	; Secondary instrument (6). Note reference (8). Primary wait (0).
	db 99	; Secondary instrument (6). Note reference (3). Primary wait (0).
	db 103	; Secondary instrument (6). Note reference (7). Primary wait (0).
	db 226	; Secondary instrument (6). Note reference (2). New wait (3).
	db 3	;   Escape wait value.
	db 107	; Secondary instrument (6). Note reference (11). Primary wait (0).
	db 110	; Secondary instrument (6). New escaped note: 20. Primary wait (0).
	db 20	;   Escape note value.
	db 101	; Secondary instrument (6). Note reference (5). Primary wait (0).
	db 98	; Secondary instrument (6). Note reference (2). Primary wait (0).
	db 47	; Secondary instrument (6). Same escaped note: 20. 
	db 111	; Secondary instrument (6). Same escaped note: 20. Primary wait (0).
	db 98	; Secondary instrument (6). Note reference (2). Primary wait (0).
	db 103	; Secondary instrument (6). Note reference (7). Primary wait (0).
	db 99	; Secondary instrument (6). Note reference (3). Primary wait (0).
	db 165	; Secondary instrument (6). Note reference (5). Secondary wait (1).
	db 99	; Secondary instrument (6). Note reference (3). Primary wait (0).
	db 103	; Secondary instrument (6). Note reference (7). Primary wait (0).
	db 168	; Secondary instrument (6). Note reference (8). Secondary wait (1).
	db 110	; Secondary instrument (6). New escaped note: 34. Primary wait (0).
	db 34	;   Escape note value.
	db 228	; Secondary instrument (6). Note reference (4). New wait (127).
	db 127	;   Escape wait value.
...
Lookool_Subsong0_Track8
	...
	db 101	; Secondary instrument (6). Note reference (5). Primary wait (0).
	db 98	; Secondary instrument (6). Note reference (2). Primary wait (0).
	db 227	; Secondary instrument (6). Note reference (3). New wait (2).
	db 2	;   Escape wait value.
	db 163	; Secondary instrument (6). Note reference (3). Secondary wait (1).
	db 99	; Secondary instrument (6). Note reference (3). Primary wait (0).
	db 103	; Secondary instrument (6). Note reference (7). Primary wait (0).
	db 98	; Secondary instrument (6). Note reference (2). Primary wait (0).
	db 168	; Secondary instrument (6). Note reference (8). Secondary wait (1).
	...
	db 111	; Secondary instrument (6). Same escaped note: 34. Primary wait (0).
	db 175	; Secondary instrument (6). Same escaped note: 34. Secondary wait (1).
	db 111	; Secondary instrument (6). Same escaped note: 34. Primary wait (0).
	db 238	; Secondary instrument (6). New escaped note: 41. New wait (127).
...
Lookool_Subsong0_Track9
	...
	db 0	;    Reset effect, with inverted volume: 0.
	db 26	; Primary instrument (5). Note reference (10). 
	db 94	; Primary instrument (5). New escaped note: 68. Primary wait (0).
	db 68	;   Escape note value.
	db 12	; Note with effects flag.
	db 86	; Primary instrument (5). Note reference (6). Primary wait (0).
	db 38	;    Arpeggio table effect 2.
	...
	db 80	; Primary instrument (5). Note reference (0). Primary wait (0).
	db 0	;    Reset effect, with inverted volume: 0.
	db 30	; Primary instrument (5). New escaped note: 56. 
	db 56	;   Escape note value.
	db 81	; Primary instrument (5). Note reference (1). Primary wait (0).
	db 80	; Primary instrument (5). Note reference (0). Primary wait (0).
	db 94	; Primary instrument (5). New escaped note: 57. Primary wait (0).
	db 57	;   Escape note value.
	db 222	; Primary instrument (5). New escaped note: 53. New wait (127).
	db 53	;   Escape note value.
	db 127	;   Escape wait value.

Lookool_Subsong0_Track10
	db 12	; Note with effects flag.
	db 235	; Secondary instrument (6). Note reference (11). New wait (15).
	db 15	;   Escape wait value.
	db 0	;    Reset effect, with inverted volume: 0.
	db 238	; Secondary instrument (6). New escaped note: 20. New wait (7).
	db 20	;   Escape note value.
	db 7	;   Escape wait value.
	db 229	; Secondary instrument (6). Note reference (5). New wait (127).
	db 127	;   Escape wait value.
...
Lookool_Subsong0_Track11
	...
	db 99	; Secondary instrument (6). Note reference (3). Primary wait (0).
	db 103	; Secondary instrument (6). Note reference (7). Primary wait (0).
	db 162	; Secondary instrument (6). Note reference (2). Secondary wait (1).
	db 171	; Secondary instrument (6). Note reference (11). Secondary wait (1).
	db 107	; Secondary instrument (6). Note reference (11). Primary wait (0).
	db 110	; Secondary instrument (6). New escaped note: 20. Primary wait (0).
	db 20	;   Escape note value.
	...
	db 98	; Secondary instrument (6). Note reference (2). Primary wait (0).
	db 47	; Secondary instrument (6). Same escaped note: 20. 
	db 110	; Secondary instrument (6). New escaped note: 32. Primary wait (0).
	db 32	;   Escape note value.
	db 99	; Secondary instrument (6). Note reference (3). Primary wait (0).
	db 98	; Secondary instrument (6). Note reference (2). Primary wait (0).
	db 46	; Secondary instrument (6). New escaped note: 20. 
	db 20	;   Escape note value.
	db 110	; Secondary instrument (6). New escaped note: 21. Primary wait (0).
	db 21	;   Escape note value.
	db 111	; Secondary instrument (6). Same escaped note: 21. Primary wait (0).
	db 111	; Secondary instrument (6). Same escaped note: 21. Primary wait (0).
	db 111	; Secondary instrument (6). Same escaped note: 21. Primary wait (0).
	db 101	; Secondary instrument (6). Note reference (5). Primary wait (0).
	db 101	; Secondary instrument (6). Note reference (5). Primary wait (0).
	db 110	; Secondary instrument (6). New escaped note: 23. Primary wait (0).
	db 23	;   Escape note value.
	db 226	; Secondary instrument (6). Note reference (2). New wait (127).
	db 127	;   Escape wait value.
...
Lookool_Subsong0_Track13
	...
	db 94	; Primary instrument (5). New escaped note: 70. Primary wait (0).
	db 70	;   Escape note value.
	db 218	; Primary instrument (5). Note reference (10). New wait (127).
	db 127	;   Escape wait value.
...
Lookool_Subsong0DisarkByteRegionStart6
	...
	db 29	; Note for index 8.
	db 63	; Note for index 9.
	db 72	; Note for index 10.
